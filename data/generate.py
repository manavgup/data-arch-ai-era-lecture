...
BRANCH_NAMES = {
    ...
    "Quebec": [
        ...
        "Montreal Saint-Catherine",
        "Quebec City Old Port",
        "Laval Carrefour",
        "Gatineau Hull",
        "Sherbrooke King",
        "Longueuil Metro",
        "Trois-Rivieres Centre",
    ],
    "BC": [
        "Vancouver Main",
        "Vancouver Robson",
...
def generate_branches(seed: int = 42) -> pd.DataFrame:
    ...
    _ = 50 - sum(region_alloc.values())  # all 50 accounted for by design
...
def generate_accounts(
    ...
    cust_opened = dict(zip(customers_df["customer_id"], pd.to_datetime(customers_df["opened_date"])))
...
def generate_transactions(
    ...
    _ = dict(zip(accounts_df["account_id"], accounts_df["customer_id"]))  # noqa: F841
...
def generate_policies(output_dir: Path, seed: int = 42) -> None:
    ...
    _style_footer = ParagraphStyle(  # noqa: F841 — reserved for future footer use
        "PolicyFooter",
        parent=styles["Normal"],
        fontSize=8,
        textColor=colors.grey,
    ...
    def build_toc_entries(sections):
        ...
        for sec_num, sec_title, _ in sections:
            toc_style = ParagraphStyle(
                ...
                fontSize=10,
                leading=16,
                leftIndent=10 * (sec_num.count(".") if "." in sec_num else 0),
            )
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "AML",
                        "Anti-Money Laundering — the set of procedures, laws, and regulations designed to prevent the practice of generating income through illegal actions.",
                    ],
                    [
                        "FINTRAC",
                        "Financial Transactions and Reports Analysis Centre of Canada — Canada's financial intelligence unit.",
                    ],
                    [
                        "PCMLTFA",
                        "Proceeds of Crime (Money Laundering) and Terrorist Financing Act — the primary Canadian AML legislation.",
                    ],
                    [
                        "STR",
                        "Suspicious Transaction Report — a report filed with FINTRAC when there are reasonable grounds to suspect ML/TF.",
                    ],
                    [
                        "LCTR",
                        "Large Cash Transaction Report — mandatory report for cash transactions of $10,000 CAD or more.",
                    ],
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Reasonable grounds to suspect ML/TF",
                        "Within 30 calendar days",
                    ],
                    [
                        "Electronic Funds Transfer Report (EFTR)",
                        "$10,000 CAD or more (international)",
                        "Within 5 business days",
                    ],
                    [
                        "Terrorist Property Report",
                        "Property owned/controlled by listed entity",
            ...
            [
                [
                    ...
                    [
                        ...
                        "Identify and report suspicious activities; perform CDD (MTB-POL-004)",
                    ],
                    [
                        "Second Line",
                        "AML Compliance and Risk Management",
                        "Policy development; transaction monitoring (MTB-POL-006); quality assurance",
                    ],
                    [
                        "Third Line",
                        "Internal Audit",
                        "Independent review of AML program effectiveness; regulatory compliance testing",
                    ],
                ],
            ],
        ),
            ...
            [
                [
                    ...
                    [
                        ...
                        "Investment account",
                        "International wire / private banking",
                    ],
                    [
                        "Transaction Behaviour",
                        "Consistent with profile",
                        "Occasional anomaly",
                        "Frequent large cash / structuring",
                    ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [
                        "Front-line staff (tellers, CSRs)",
                        "Semi-annually",
                        "Red flags, customer identification, STR escalation",
                    ],
                    ...
                    [
                        "Board of Directors",
                        "Annually",
                        "Strategic AML risk, regulatory landscape, program effectiveness",
                    ],
                ],
            ],
        ),
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Layering",
                        "The process of separating illicit funds from their source through complex transactions",
                    ],
                ],
            ],
        ),
    ...
    policy_002_sections = [
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Self-declaration, employer letter",
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [
                        "High (71-85)",
                        "Enhanced Due Diligence (MTB-POL-005)",
                        "Semi-annually",
                        "Senior Compliance Officer",
                    ],
                    [
                        "Very High (86-100)",
                        "Enhanced Due Diligence + CAMLO review",
                        "Quarterly",
                        "CAMLO + Senior Management",
                    ],
                ],
            ],
        ),
        ...
        (
            "5.1",
            "Trigger Events for KYC Refresh",
            [
            ...
            [
                [
                    ...
                    [
                        ...
                        "Collect and verify customer identification; complete CIP forms",
                    ],
    ...
    policy_003_sections = [
        ...
        (
            "3.3",
            "International Electronic Funds Transfer Reports",
            [
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Structuring",
                        "Multiple deposits just under $10,000; use of multiple branches for similar amounts",
                    ],
            ...
            [
                [
                    ...
                    [
                        ...
                        "Risk score >= 71 or PEP (MTB-POL-008)",
                    ],
                    ["Individual — Wealth", "Dual ID + source of wealth", "All wealth clients >= $1M AUM"],
                    [
                        "Corporate — SME",
                        "Business registration + beneficial ownership",
                        "Cash-intensive business or high-risk sector",
                    ],
                    [
                        "Corporate — Large",
                        "Full corporate docs + BO + audited financials",
                        "Complex ownership or foreign control",
                    ],
                    [
                        "Institutional",
                        "Regulatory status + authorized signatories",
                        "Non-regulated or foreign institution",
                    ],
                ],
            ],
        ),
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Investment Account",
                        "Investment knowledge assessment; risk tolerance; source of initial deposit",
                    ],
                    ["Credit Card", "Credit bureau check; income verification; employment confirmation"],
                    [
                        "International Wire Services",
                        "Purpose of transfers; beneficiary relationship; country risk assessment",
                    ],
    ...
    policy_005_sections = [
        ...
        (
            "4",
            "Enhanced Transaction Monitoring for EDD Customers",
            [
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Transaction history + customer profile",
                    ],
                    ...
                    [
                        ...
                        "Transaction counterparty network",
                    ],
                ],
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "TM-002",
                        "Aggregate cash in 24 hours (same customer)",
                        ">= $10,000 CAD",
                        "Medium — auto-generates LCTR",
                    ],
                    [
                        "TM-003",
                        "Cash transactions just below threshold",
                        "$8,000-$9,999 (3+ occurrences in 7 days)",
                        "High — potential structuring",
                    ],
                    [
                        "TM-004",
                        "Cash deposits inconsistent with profile",
                        "> 200% of expected monthly average",
                        "Medium",
                    ],
                ],
            ],
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "TM-007",
                        "Rapid wire transfer pattern (in-and-out)",
                        "Wire out within 48 hours of deposit",
                        "High",
                    ],
            ...
            [
                [
                    ...
                    [
                        ...
                        "> 300% of 6-month average transaction count",
                        "Medium",
                    ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [
                        "Domestic PEP",
                        "Person who holds or has held a prescribed position in Canada",
                        "Members of Parliament, Senators, Mayors of major cities, Deputy Ministers, Judges of superior courts, Heads of Crown corporations",
                    ],
                    [
                        "Foreign PEP",
                        "Person who holds or has held a prescribed position in a foreign state",
                        "Heads of state, Cabinet ministers, Senior military officers, Judges of supreme/constitutional courts, Ambassadors",
                    ],
                    [
                        "Head of International Organization (HIO)",
                        "Person who is head of an international organization established by governments",
                        "UN Secretary-General, World Bank President, IMF Managing Director, NATO Secretary-General",
                    ],
                    [
                        "PEP Family Member",
                        "Spouse, child, parent, sibling of a PEP",
                        "As defined in PCMLTFA regulations",
                    ],
                    [
                        "Close Associate",
                        "Person closely associated with a PEP for personal or business reasons",
                        "Business partners, legal advisors, persons in financial arrangements with PEP",
                    ],
                ],
            ],
        ),
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Foreign PEP",
                        "EDD + source of wealth + senior management approval",
                        "CAMLO + SVP Risk",
                        "Semi-annually",
                    ],
                    ...
                    [
                        ...
                        "Same as associated PEP category",
                        "Same as associated PEP",
                        "Same as associated PEP",
                    ],
                ],
            ],
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Customer identification (ID copies, verification)",
                        "5 years",
                        "After account closure / last transaction",
                        "Secure digital archive",
                    ],
                    ["Transaction records (all types)", "5 years", "From date of transaction", "Data warehouse"],
                    [
                        "STR and supporting documents",
                        "5 years",
                        "From date of filing",
                        "Restricted access — AML system",
                    ],
                    ...
                    [
                        "Board and committee minutes (AML-related)",
                        "10 years",
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Restricted",
                        "Highly sensitive — regulatory/legal significance",
                        "Role-based, need-to-know, encrypted",
                        "STRs, law enforcement requests, CAMLO files",
                    ],
                    [
                        "Confidential",
                        "Sensitive business and customer data",
                        "Role-based access, encrypted at rest",
                        "Customer PII, transaction data, risk scores",
                    ],
                    [
                        "Internal",
                        "Business information not for public disclosure",
                        "All employees with business need",
                    ...
                    [
                        ...
                        "No restriction",
                        "Marketing materials, published rates",
                    ],
                ],
            ],
        ),
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Secure deletion with overwrite (NIST 800-88)",
                        "Deletion log with timestamp",
                    ],
                    [
                        "Digital records — restricted",
                        "Cryptographic erasure or physical media destruction",
                        "Certificate of destruction",
                    ],
            ...
            [
                ...
                [
                    ...
                    [
                        "Customer Risk",
                        "35%",
                        "Customer type, PEP status, sanctions nexus, geographic location, source of wealth",
                    ],
                    [
                        "Product/Service Risk",
                        "25%",
                        "Cash intensity, anonymity features, international capability, value",
                    ],
            ...
            [
                ...
                [
                    ...
                    [
                        "Customer Type",
                        "20%",
                        "Individual retail (1-2), Commercial (3-5), Wealth (4-6), Institutional (3-7), Cash-intensive business (7-10)",
                    ],
                    [
                        "Geographic Risk",
                        "20%",
                        "Canada (1-3), US/EU/UK/Australia (3-5), Other low-risk (5-7), Medium-risk (7-8), FATF high-risk (9-10)",
                    ],
                    [
                        "Product Risk",
                        "15%",
                        "Savings (1-2), Chequing (2-3), Investment (3-5), Credit (3-5), International wire (6-8), Private banking (7-9)",
                    ],
                    [
                        "Transaction Behaviour",
                        "25%",
                        "Based on 6-month transaction history and anomaly detection (MTB-POL-006)",
                    ],
                    [
                        "Tenure and Relationship",
                        "10%",
                        "Long-standing (1-3), Medium (4-6), New (7-8), New + high-value (8-10)",
                    ],
                    [
                        "Source of Funds/Wealth",
                        "10%",
                        "Employment (1-3), Business revenue (3-5), Investment returns (3-5), Unknown (8-10)",
                    ],
                ],
            ...
            (
                ...
                [
                    ...
                    [
                        ...
                        [
                            "Minor",
                            "Incomplete documentation; late filing of internal forms",
                            "Coaching, additional training, documented warning",
                        ],
                        [
                            "Moderate",
                            "Failure to complete required KYC refresh; missed periodic review deadline",
                            "Written warning, mandatory retraining, performance impact",
                        ],
                        [
                            "Serious",
                            "Failure to file STR when warranted; tipping off customer",
                            "Suspension, termination, regulatory reporting",
                        ],
                        [
                            "Critical",
                            "Deliberate facilitation of ML/TF; destruction of records",
                            "Immediate termination, law enforcement referral, regulatory reporting",
                        ],
                    ],
                ],
            )
                ...
                [
                    ...
                    [
                        ...
                        [
                            ...
                            "Primary Canadian AML/ATF legislation",
                        ],
                        [
                            "PCMLTFA Regulations",
                        ...
                        [
                            "OSFI B-8",
                            "OSFI Guideline B-8: Deterring and Detecting Money Laundering and Terrorist Financing",
                            "Supervisory expectations for federally regulated financial institutions",
                        ],
                        [
                            "FINTRAC Guidance",
                            "FINTRAC Guidance on Reporting, Record-Keeping, Client Identification, and Compliance Programs",
                            "Operational guidance from Canada's financial intelligence unit",
                        ],
                        [
                            "Criminal Code",
                            "Criminal Code of Canada, Part XII.2 — Proceeds of Crime",
                        ...
                        [
                            ...
                            "Canadian autonomous sanctions authority",
                        ],
                        [
                        ...
                        [
                            ...
                            "Privacy requirements for customer data handling",
                        ],
                        [
                            "Magnitsky Law",
                            "Justice for Victims of Corrupt Foreign Officials Act, S.C. 2017, c. 21",
                            "Sanctions against foreign corrupt officials",
                        ],
                    ],
            ...
            (
                ...
                [
                    ...
                    [
                        ...
                        [
                            "MTB-POL-001",
                            "Anti-Money Laundering (AML) Program Policy",
                            "Overarching AML program framework",
                        ],
                        [
                            "MTB-POL-002",
                        ...
                        [
                            ...
                            "STR filing process and red flag indicators",
                        ],
                        [
                            "MTB-POL-004",
                            "Customer Due Diligence (CDD) Standards",
                            "Standard and ongoing CDD requirements",
                        ],
                        [
                            "MTB-POL-005",
                            "Enhanced Due Diligence (EDD) for High-Risk Customers",
                            "Additional due diligence for elevated risk",
                        ],
                        [
                            "MTB-POL-006",
                            "Transaction Monitoring Program",
                            "Automated and manual transaction surveillance",
                        ],
                        [
                            "MTB-POL-007",
                            "Sanctions Screening Procedures",
                            "Sanctions list screening and alert handling",
                        ],
                        [
                            "MTB-POL-008",
                        ...
                        [
                            ...
                            "Record-keeping and data lifecycle management",
                        ],
                ...
                [
                    [
                        ...
                        [
                            ...
                            "Within 90 days of regulatory change",
                            "AML Compliance team",
                            "CAMLO + CCO",
                        ],
                        [
                            "Incident-triggered review",
                            "Within 30 days of material incident",
                            "AML Compliance + Internal Audit",
                            "Risk Committee",
                        ],
                        [
                            "Effectiveness review",
                            "Biennially",
                            "External reviewer (as per PCMLTFA)",
                            "Board of Directors",
                        ],
                    ],
    ...
    policy_001_extra = [
        ...
        (
            "11.1.1",
            "Case Study 1: Structuring Through Multiple Branches",
            [
        ...
        (
            "11.1.2",
            "Case Study 2: Layering Through International Wires",
            [
            ...
            [
                ...
                [
                    [
                        "Jurisdiction",
                        "Local Regulator",
                        "AML Standard Assessment",
                        "Key Differences from Canadian Requirements",
                    ],
                    ...
                    [
                        ...
                        "CIMA",
                        "Lower in some areas",
                        "Enhanced oversight required per OSFI expectations",
                    ],
                ],
            ],
        ),
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Real-time feed from core banking",
                    ],
                    [
                        "Sanctions Screening",
                        "Commercial vendor",
                        "Real-time screening against sanctions lists",
                        "Integrated with wire transfer system",
                    ],
                    [
                        "Case Management",
                        "Internal system",
                        "Alert investigation and STR workflow",
                        "Fed by monitoring and screening systems",
                    ],
                    [
                        "Customer Risk Scoring",
                        "ML model (internal)",
                        "Dynamic risk score calculation",
                        "Integrated with CRM and core banking",
                    ],
                    [
                        "Name Screening",
                        "Commercial vendor",
                    ...
                    [
                        ...
                        "Internal system",
                        "Automated LCTR and EFTR generation",
                        "Direct submission to FINTRAC via F2R",
                    ],
                ],
        ...
        (
            "13.2",
            "Emerging Risk: Digital Assets and Cryptocurrency",
            [
        ...
        (
            "15",
            "AML Program Budget and Resource Allocation",
            [
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "CAMLO Quarterly Report",
                        "AML Compliance",
                        "Risk Committee",
                        "Quarterly",
                        "Program performance, alert volumes, STR trends, regulatory updates",
                    ],
                    [
                        "AML Dashboard",
                        "AML Operations",
                        "CAMLO, CCO",
                        "Monthly",
                        "KRIs, alert metrics, case aging, staffing",
                    ],
                    [
                        ...
                        "Board of Directors",
                        "Annually",
                        "Inherent risk, control effectiveness, residual risk, action plans",
                    ],
                    [
                        "Effectiveness Review",
                        "External Reviewer",
                        "Board of Directors",
                        "Biennially",
                        "Independent assessment of AML program effectiveness per PCMLTFA",
                    ],
                    [
                        "Regulatory Exam Summary",
                        "CAMLO",
                        "Risk Committee, Board",
                        "As needed",
                        "Summary of OSFI/FINTRAC examination findings and remediation plans",
                    ],
                ],
            ],
        ),
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Risk-based (typically every 2-3 years)",
                        "All aspects of AML program; policies, controls, testing",
                    ],
                    [
                        "FINTRAC",
                        "Compliance examination",
                        "Risk-based",
                        "Reporting obligations, record-keeping, compliance program",
                    ],
                    [
                        "External Auditor",
                        "AML program effectiveness review",
                        "Biennially (per PCMLTFA s. 9.6)",
                    ...
                    [
                        ...
                        "Annually",
                        "Design and operating effectiveness of AML controls",
                    ],
                ],
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Photo ID scanning and authentication",
                        "High",
                        "Requires clear image; some foreign IDs not supported",
                    ],
                    [
                        "Biometric verification",
                        "Facial recognition comparison to ID photo",
                        "High",
                        "Requires customer consent; accessibility considerations",
                    ],
                    [
                        "Credit bureau verification",
                        "Identity confirmation via credit file match",
                        "Medium-High",
                        "Requires existing credit history; not available for newcomers",
                    ],
                    [
                        "Digital ID services",
                        "Government digital identity (where available)",
                        "Very High",
                        "Limited availability across provinces",
                    ],
                    [
                        "Knowledge-based authentication",
                        "Questions based on credit/public records",
                        "Medium",
                        "Susceptible to social engineering; supplementary only",
                    ],
                ],
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "New account KYC file review",
                        "5% of new accounts per branch per month",
                        "Monthly",
                        "Branch Compliance Officer",
                    ],
                    ["KYC refresh completeness check", "10% of due refreshes", "Quarterly", "AML Compliance team"],
                    [
                        "Digital onboarding verification review",
                        "3% of digital accounts",
                        "Monthly",
                        "Digital Compliance team",
                    ],
        ...
        (
            ...
            [
                [
                    ...
                    [
                        "Vague narrative",
                        "FINTRAC cannot assess the suspicion",
                        "Provide specific facts, amounts, dates, and context",
                    ],
                    [
                        "Missing transaction details",
                        "Incomplete picture of the activity",
                        "Include all relevant transactions, not just the triggering one",
                    ],
                    [
                        "No customer context",
                        "Cannot assess if activity is truly unusual",
                        "Describe the customer's profile, history, and expected behaviour",
                    ],
                    [
                        "Delayed filing",
                        "Regulatory non-compliance; penalty risk",
                        "File within 30 calendar days of determination",
                    ],
                    [
                        "Over-reliance on system alerts",
                        "Does not explain human assessment of suspicion",
                        "Document the analyst's own assessment and reasoning",
                    ],
                ],
            ],
        ),
    ...
    policy_004_extra = [
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [
                        "Trustee(s)",
                        "Full name, DOB, address, professional qualifications",
                        "Government-issued photo ID; professional registration",
                    ],
                    ...
                    [
                        "Protector (if any)",
                        "Full name, DOB, address, powers held",
                        "Government-issued photo ID; trust deed",
                    ],
                ],
        ...
        (
            "12",
            "CDD for Non-Profit Organizations",
            [
        ...
        (
            "13",
            "CDD in Mergers and Acquisitions",
            [
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Yes",
                        "Listed on a recognized Canadian exchange; annual filings current",
                    ],
                    [
                        "Regulated financial institutions",
                        "Yes",
                        "Subject to PCMLTFA or equivalent foreign AML regulation",
                    ],
                    ...
                    [
                        ...
                        "Yes",
                        "Registered under the Pension Benefits Standards Act or provincial equivalent",
                    ],
                ],
    ...
    policy_005_extra = [
        ...
        (
            "7.1",
            "Case Study: High-Risk Jurisdiction",
            [
        ...
        (
            "7.2",
            "Case Study: Complex Corporate Ownership",
            [
        ...
        (
            "9",
            "EDD Staff Competency Requirements",
            [
    ...
    policy_006_extra = [
            ...
            [
                [
                    ...
                    [
                        ...
                        ">= 10%",
                        "Review scenario rules and thresholds",
                    ],
                    [
                        "Recall",
                        "True Positives / (True Positives + False Negatives)",
                        ">= 95%",
                        "Expand scenario coverage; lower thresholds",
                    ],
                    [
                        "F1 Score",
                    ...
                    [
                        "Alert-to-SAR ratio",
                        "SARs filed / Total alerts investigated",
                        ">= 5%",
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [
                        "Real-time",
                        "Sanctions screening; high-priority wire transfers",
                        "Continuous",
                        "Immediate — blocks transaction pending review",
                    ],
                    [
                        "Near real-time",
                        "Large cash transactions; EFT threshold detection",
                        "Every 15 minutes",
                        "Alert queue within 30 minutes",
                    ],
                    [
                        "Daily batch",
                        "All rule-based scenarios; ML anomaly scoring",
                        "Nightly (2:00 AM ET)",
                        "Alert queue by 7:00 AM ET",
                    ],
                    [
                        "Weekly batch",
                        "Network analysis; relationship pattern detection",
                        "Sunday (midnight ET)",
                        "Alert queue by Monday 7:00 AM ET",
                    ],
                    [
                        "Monthly batch",
                        "Customer behaviour profiling; peer group analysis",
                        "1st of each month",
                        "Alert queue within 24 hours",
                    ],
                ],
            ],
        ),
        (
            "12",
            "Data Requirements for Transaction Monitoring",
            [
                ...
                [
                    ...
                    [
                        ...
                        "Core banking",
                        "Daily",
                        "Account, amount, date, type, counterparty",
                        "99.5% completeness",
                    ],
                    [
                        "Wire transfers",
                        "SWIFT gateway",
                        "Real-time",
                        "Sender, receiver, amount, currency, country",
                        "99.9% completeness",
                    ],
                    [
                        "Customer profile",
                        "CRM",
                        "Daily",
                        "Name, DOB, occupation, risk score, segment",
                        "99.0% completeness",
                    ],
                    [
                        "Account data",
                        "Core banking",
                        "Daily",
                        "Account type, status, balance, branch",
                        "99.5% completeness",
                    ],
                    [
                        "KYC status",
                        "KYC platform",
                        "Daily",
                        "Verification status, expiry, risk level",
                        "99.0% completeness",
                    ],
                    [
                        "Sanctions lists",
                        "Vendor feed",
                        "Daily",
                        "Name, aliases, DOB, country, list source",
                        "100% completeness",
                    ],
                ],
        ...
        (
            "13.1",
            "Mortgage and Lending Monitoring",
            [
    ...
    policy_007_extra = [
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Detailed sanctions screening; hold procedures; alert handling",
                        "Semi-annually",
                    ],
                    [
                        "Compliance analysts",
                        "Advanced sanctions analysis; list interpretation; disposition",
                        "Quarterly",
                    ],
                    [
                        "Senior management",
                        "Sanctions program governance; regulatory obligations; risk oversight",
                        "Annually",
                    ],
                ],
            ],
        ...
        (
            "11",
            "Record Keeping for Sanctions Screening",
            [
    ...
    policy_008_extra = [
        ...
        (
            "8",
            "PEP Risk Assessment Integration",
            [
    ...
    policy_009_extra = [
            ...
            [
                [
                    ...
                    [
                        ...
                        "Enterprise data strategy and governance oversight",
                        "Data governance program effectiveness",
                    ],
                    [
                        "Data Stewards",
                        "Domain-specific data quality and standards management",
                        "Data quality within assigned domains",
                    ],
                    [
                        "Data Custodians",
                        "Technical management of data storage and access controls",
                        "System availability and data security",
                    ],
                    [
                        "Data Owners",
                        "Business accountability for data assets in their domain",
                        "Data classification and access decisions",
                    ],
                    [
                        "Privacy Officer",
                        "PIPEDA compliance and privacy impact assessments",
                        "Privacy compliance across all data domains",
                    ],
                ],
            ],
        ),
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Unmodified source data; full fidelity",
                        "Per source system SLA (minimum 90 days)",
                    ],
                    [
                        "Curated / Conformed",
                        "Cleaned, validated, and standardized data",
                        "Deduplicated; schema-enforced; master data linked",
                        "Per business domain requirements",
                    ],
                    [
                        "Consumed / Presentation",
                        "Analytics, reporting, and application data",
                        "Aggregated; enriched; business-ready",
                        "Per reporting and regulatory requirements",
                    ],
                ],
        ...
        (
            ...
            [
                ...
                [
                    ...
                    [
                        "FINTRAC production order",
                        "Within the timeframe specified in the order",
                        "Legal + CAMLO",
                        "Legal reviews order; coordinates data retrieval",
                    ],
                    [
                        "FINTRAC voluntary information request",
                        "30 calendar days",
                        "CAMLO",
                        "CAMLO reviews and coordinates response",
                    ],
                    [
                        "OSFI examination data request",
                        "As specified by OSFI",
                        "CCO + CRO",
                        "Compliance coordinates data retrieval",
                    ],
                    [
                        "Law enforcement production order",
                        "Per court order terms",
                        "Legal + CAMLO",
                        "Legal reviews order; coordinates with law enforcement",
                    ],
                    [
                        "Customer access request (PIPEDA)",
                        "30 calendar days",
                        "Privacy Officer",
                        "Privacy team processes request",
                    ],
                ],
            ],
        ),
        (
            "10",
            "Disaster Recovery for AML Records",
            [
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "% of customer base rated High or Very High",
                        "> 8%",
                        "> 12%",
                        "Monthly",
                    ],
                    ...
                    [
                        ...
                        "Cash transactions as % of total (by value)",
                        "> 15%",
                        "> 25%",
                        "Monthly",
                    ],
                    [
                        "International wire concentration",
                        "% of wires to/from high-risk jurisdictions",
                        "> 5%",
                        "> 10%",
                        "Monthly",
                    ],
                    [
                        "New high-risk customer volume",
                        "Number of new high-risk customers per month",
                        "> 50",
                        "> 100",
                        "Monthly",
                    ],
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        "Does the third party have an AML program commensurate with the services provided?",
                    ],
                    ...
                    [
                        "Concentration risk",
                        "Is the Bank overly dependent on this third party for a critical AML function?",
                    ],
    ...
    graph = {
        "nodes": [
            # Raw layer — source system extracts
            {
                "id": "raw.transactions",
                "layer": "raw",
                "source": "core_banking_extract",
                "format": "csv",
                "description": "Daily transaction extract from core banking system",
                "refresh": "daily",
            ...
            },
            {
                ...
                "source": "core_banking_extract",
                "format": "csv",
                "description": "Account master data from core banking",
                "refresh": "daily",
                "owner": "data_engineering",
            },
            {
                "id": "raw.branches",
                "layer": "raw",
                "source": "branch_management_system",
                "format": "csv",
                "description": "Branch reference data",
                "refresh": "weekly",
                "owner": "data_engineering",
            },
            {
                "id": "raw.kyc_records",
                "layer": "raw",
                "source": "kyc_platform_extract",
                "format": "json",
                "description": "KYC verification records and status",
                "refresh": "daily",
                "owner": "compliance_data",
            },
            {
                "id": "raw.sanctions_lists",
                "layer": "raw",
                "source": "sanctions_vendor_feed",
                "format": "xml",
                "description": "Consolidated sanctions lists from vendor",
                "refresh": "daily",
                "owner": "compliance_data",
            },
            {
                "id": "raw.wire_transfers",
                "layer": "raw",
                "source": "swift_gateway",
                "format": "csv",
                "description": "International wire transfer messages",
                "refresh": "real-time",
                "owner": "data_engineering",
            },
            # Curated layer — cleaned and transformed
            {
                "id": "curated.transactions_clean",
                "layer": "curated",
                "source": "spark_etl_job_001",
                "format": "parquet",
                "description": "Deduplicated transactions with normalized currencies",
                "refresh": "daily",
                "owner": "data_engineering",
            },
            {
                "id": "curated.customer_360",
                "layer": "curated",
                "source": "mdm_pipeline",
                "format": "parquet",
                "description": "Unified customer view with resolved entities",
                "refresh": "daily",
                "owner": "mdm_team",
            },
            {
                "id": "curated.accounts_enriched",
                "layer": "curated",
                "source": "spark_etl_job_002",
                "format": "parquet",
                "description": "Accounts enriched with customer and branch data",
                "refresh": "daily",
                "owner": "data_engineering",
            },
            {
                "id": "curated.kyc_status_current",
                "layer": "curated",
                "source": "spark_etl_job_003",
                "format": "parquet",
                "description": "Current KYC status with expiry tracking",
                "refresh": "daily",
                "owner": "compliance_data",
            },
            {
                "id": "curated.wire_transfers_enriched",
                "layer": "curated",
                "source": "spark_etl_job_004",
                "format": "parquet",
                "description": "Wire transfers enriched with country risk scores",
                "refresh": "daily",
                "owner": "data_engineering",
            },
            {
                "id": "curated.sanctions_reference",
                "layer": "curated",
                "source": "sanctions_etl_pipeline",
                "format": "parquet",
                "description": "Normalized sanctions list for screening",
                "refresh": "daily",
                "owner": "compliance_data",
            },
            # Consumed layer — analytics and reporting
            {
                "id": "consumed.branch_summary_quarterly",
                "layer": "consumed",
                "source": "dbt_model_branch_agg",
                "format": "iceberg",
                "description": "Quarterly branch performance summary",
                "refresh": "quarterly",
                "owner": "analytics_team",
            },
            {
                "id": "consumed.aml_alerts",
                "layer": "consumed",
                "source": "aml_scoring_pipeline",
                "format": "parquet",
                "description": "AML risk alerts from transaction monitoring",
                "refresh": "daily",
                "owner": "aml_operations",
            },
            {
                "id": "consumed.customer_risk_scores",
                "layer": "consumed",
                "source": "risk_scoring_model_v3",
                "format": "parquet",
                "description": "Customer ML/TF risk scores",
                "refresh": "daily",
                "owner": "aml_operations",
            },
            {
                "id": "consumed.regulatory_reports",
                "layer": "consumed",
                "source": "reporting_pipeline",
                "format": "csv",
                "description": "FINTRAC regulatory report data (LCTRs, STRs, EFTRs)",
                "refresh": "daily",
                "owner": "compliance_data",
            },
            {
                "id": "consumed.customer_segmentation",
                "layer": "consumed",
                "source": "ml_segmentation_model",
                "format": "parquet",
                "description": "Customer segmentation for marketing and risk",
                "refresh": "monthly",
                "owner": "analytics_team",
            },
            {
                "id": "consumed.kyc_dashboard_data",
                "layer": "consumed",
                "source": "dbt_model_kyc_metrics",
                "format": "iceberg",
                "description": "KYC compliance metrics for dashboard",
                "refresh": "daily",
                "owner": "compliance_data",
            },
        ],
        "edges": [
            # Raw to Curated
            {
                ...
                "to": "curated.transactions_clean",
                "transform": "dedup + schema enforcement + currency normalization to CAD (Bank of Canada daily rates)",
            },
            {
                "from": "raw.customers",
                "to": "curated.customer_360",
                "transform": "entity resolution + dedup + PII standardization + address normalization",
            },
            {
                "from": "raw.accounts",
                "to": "curated.accounts_enriched",
                "transform": "join with customer_360 and branches + status derivation + balance validation",
            },
            {
                "from": "raw.branches",
                "to": "curated.accounts_enriched",
                "transform": "branch reference data lookup for region and manager enrichment",
            },
            {
                "from": "raw.kyc_records",
                "to": "curated.kyc_status_current",
                "transform": "flatten JSON + compute expiry dates + derive current status",
            },
            {
                "from": "raw.sanctions_lists",
                "to": "curated.sanctions_reference",
                "transform": "XML parsing + normalization + alias expansion + dedup",
            },
            {
                "from": "raw.wire_transfers",
                "to": "curated.wire_transfers_enriched",
                "transform": "SWIFT message parsing + country risk scoring + currency conversion",
            },
            {
                "from": "raw.customers",
                "to": "curated.accounts_enriched",
                "transform": "customer dimension lookup for account enrichment",
            },
            # Curated to Curated (cross-enrichment)
            {
                "from": "curated.customer_360",
                "to": "curated.accounts_enriched",
                "transform": "customer segment and risk profile join",
            },
            {
                "from": "curated.transactions_clean",
                "to": "curated.wire_transfers_enriched",
                "transform": "transaction reference matching for wire transfers",
            },
            # Curated to Consumed
            {
                "from": "curated.transactions_clean",
                "to": "consumed.branch_summary_quarterly",
                "transform": "aggregate by branch + quarter, compute volume/value metrics",
            },
            {
                "from": "curated.accounts_enriched",
                "to": "consumed.branch_summary_quarterly",
                "transform": "account count and balance aggregation by branch",
            },
            {
                "from": "curated.transactions_clean",
                "to": "consumed.aml_alerts",
                "transform": "rule-based scenario detection + ML anomaly scoring",
            },
            {
                "from": "curated.customer_360",
                "to": "consumed.aml_alerts",
                "transform": "customer risk profile enrichment for alert context",
            },
            {
                "from": "curated.wire_transfers_enriched",
                "to": "consumed.aml_alerts",
                "transform": "high-risk jurisdiction detection + pattern analysis",
            },
            {
                "from": "curated.customer_360",
                "to": "consumed.customer_risk_scores",
                "transform": "weighted risk factor scoring model (MTB-POL-010 methodology)",
            },
            {
                "from": "curated.transactions_clean",
                "to": "consumed.customer_risk_scores",
                "transform": "transaction behaviour features (6-month rolling window)",
            },
            {
                "from": "curated.kyc_status_current",
                "to": "consumed.customer_risk_scores",
                "transform": "KYC status and verification completeness features",
            },
            {
                "from": "curated.transactions_clean",
                "to": "consumed.regulatory_reports",
                "transform": "filter cash >= $10K CAD for LCTR; flag suspicious for STR review",
            },
            {
                "from": "curated.wire_transfers_enriched",
                "to": "consumed.regulatory_reports",
                "transform": "filter international EFTs >= $10K CAD for IEFTR generation",
            },
            {
                "from": "curated.customer_360",
                "to": "consumed.customer_segmentation",
                "transform": "feature engineering + k-means clustering + segment labelling",
            },
            {
                "from": "curated.transactions_clean",
                "to": "consumed.customer_segmentation",
                "transform": "transaction pattern features for behavioural segmentation",
            },
            {
                "from": "curated.kyc_status_current",
                "to": "consumed.kyc_dashboard_data",
                "transform": "aggregate KYC metrics by status, segment, branch; compute SLA compliance",
            },
            {
                "from": "curated.customer_360",
                "to": "consumed.kyc_dashboard_data",
                "transform": "customer segment dimensions for KYC metric drill-down",
            },
            {
                "from": "curated.sanctions_reference",
                "to": "consumed.aml_alerts",
                "transform": "real-time name/entity matching against normalized sanctions list",
            },
        ],
        "metadata": {
...
def main():
    parser = argparse.ArgumentParser(description="Generate synthetic BFSI dataset for Maple Trust Bank.")
